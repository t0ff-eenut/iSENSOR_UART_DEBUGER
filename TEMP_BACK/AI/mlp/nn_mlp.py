...
class MLP_Module:
    ...
    # data_train.csv (prepare_data.py 출력) 기준 25개 특징 인덱스
    # · magnitudes_1 ~ magnitudes_15 : col 1~15  (15개, 저주파 구간 에너지)
    # · peak_freq(151), peak_mag(152), std_mag(154), centroid(155),
    #   low_energy(156), mid_energy(157), rms(159),
    #   low_ratio(160), spectral_entropy(161), peak_to_mean(162) : 10개
    MLP_FEATURE_INDICES: list = (
        list(range(1, 16))          # magnitudes_1 ~ magnitudes_15
        + [151, 152, 154, 155, 156, 157, 159, 160, 161, 162]
    )
    ...
    def __init__(self):
        ...
        # MLP 전용 25개 특징 인덱스 (data_train.csv 컬럼 기준)
        self.feature_indices: list = MLP_Module.MLP_FEATURE_INDICES
        self.input_size: int       = len(self.feature_indices)  # 25
...
if __name__ == "__main__":
    ...
    TRAIN_CSV  = os.path.join(_SCRIPT_DIR, 'data_train.csv')
    VAL_CSV    = os.path.join(_SCRIPT_DIR, 'data_val.csv')
