...
###############################################################################################
A_graph_handle.append(gs_bandfilter)
###############################################################################################
    ...
    try:
        while True:
            ...
            if not Q_adc_delta_graph_data_buffer.empty():
                ...
                A_graph_handle[C_GRAPH_DEFINE.ADC_DELTA_GRAPH].A_data_windows[C_CURVE_DEFINE.DATA_CURVE] = A_receive_data[C_CURVE_DEFINE.DATA_CURVE]
                A_graph_handle[C_GRAPH_DEFINE.ADC_DELTA_GRAPH_ZOOM].A_data_windows[C_CURVE_DEFINE.DATA_CURVE] = A_receive_data[C_CURVE_DEFINE.DATA_CURVE]
                # print("graph_data_setting() - A_graph_handle[C_GRAPH_DEFINE.ADC_DELTA_GRAPH].A_data_windows[C_CURVE_DEFINE.DATA_CURVE] : ", A_graph_handle[C_GRAPH_DEFINE.ADC_DELTA_GRAPH].A_data_windows[C_CURVE_DEFINE.DATA_CURVE])
                # print("graph_data_setting() - A_graph_handle[C_GRAPH_DEFINE.ADC_DELTA_GRAPH_ZOOM].A_data_windows[C_CURVE_DEFINE.DATA_CURVE] : ", A_graph_handle[C_GRAPH_DEFINE.ADC_DELTA_GRAPH_ZOOM].A_data_windows[C_CURVE_DEFINE.DATA_CURVE])
                ...
                A_graph_handle[C_GRAPH_DEFINE.ADC_DELTA_GRAPH].A_data_windows[C_CURVE_DEFINE.OCCU_CURVE] = A_occu_data
                ...
                A_graph_handle[C_GRAPH_DEFINE.ADC_DELTA_GRAPH_ZOOM].A_data_windows[C_CURVE_DEFINE.OCCU_CURVE] = A_occu_zoom_data
                # print("graph_data_setting() - A_graph_handle[C_GRAPH_DEFINE.ADC_DELTA_GRAPH].A_data_windows[C_CURVE_DEFINE.OCCU_CURVE] : ", A_graph_handle[C_GRAPH_DEFINE.ADC_DELTA_GRAPH].A_data_windows[C_CURVE_DEFINE.OCCU_CURVE])
                # print("graph_data_setting() - A_graph_handle[C_GRAPH_DEFINE.ADC_DELTA_GRAPH_ZOOM].A_data_windows[C_CURVE_DEFINE.OCCU_CURVE] : ", A_graph_handle[C_GRAPH_DEFINE.ADC_DELTA_GRAPH_ZOOM].A_data_windows[C_CURVE_DEFINE.OCCU_CURVE])

                # print("A_receive_data[C_CURVE_DEFINE.TP1_CURVE] : ", A_receive_data[C_CURVE_DEFINE.TP1_CURVE])
                # print("A_graph_handle[C_GRAPH_DEFINE.ADC_DELTA_GRAPH].A_data_windows : ", A_graph_handle[C_GRAPH_DEFINE.ADC_DELTA_GRAPH].A_data_windows)
                A_graph_handle[C_GRAPH_DEFINE.ADC_DELTA_GRAPH].A_data_windows[C_CURVE_DEFINE.TP1_CURVE] = A_receive_data[C_CURVE_DEFINE.TP1_CURVE]
                A_graph_handle[C_GRAPH_DEFINE.ADC_DELTA_GRAPH_ZOOM].A_data_windows[C_CURVE_DEFINE.TP1_CURVE] = A_receive_data[C_CURVE_DEFINE.TP1_CURVE]
                # A_graph_handle[C_GRAPH_DEFINE.ADC_DELTA_GRAPH].A_data_windows[C_CURVE_DEFINE.TP1_CURVE].append(A_receive_data[C_CURVE_DEFINE.TP1_CURVE])
                # A_graph_handle[C_GRAPH_DEFINE.ADC_DELTA_GRAPH_ZOOM].A_data_windows[C_CURVE_DEFINE.TP1_CURVE].append(A_receive_data[C_CURVE_DEFINE.TP1_CURVE])

                # print("graph_data_setting() - A_graph_handle[C_GRAPH_DEFINE.ADC_DELTA_GRAPH].A_data_windows[C_CURVE_DEFINE.TP1_CURVE] : ", A_graph_handle[C_GRAPH_DEFINE.ADC_DELTA_GRAPH].A_data_windows[C_CURVE_DEFINE.TP1_CURVE])
                # print("graph_data_setting() - A_graph_handle[C_GRAPH_DEFINE.ADC_DELTA_GRAPH_ZOOM].A_data_windows[C_CURVE_DEFINE.TP1_CURVE] : ", A_graph_handle[C_GRAPH_DEFINE.ADC_DELTA_GRAPH_ZOOM].A_data_windows[C_CURVE_DEFINE.TP1_CURVE])


                # for i_curve_data_index in range(C_CURVE_DEFINE.GRAPH_START, C_CURVE_DEFINE.CURVE_DEFINE_ARRAY_SIZE+1, 1):
                ...
                #         A_graph_handle[C_GRAPH_DEFINE.ADC_DELTA_GRAPH_ZOOM].A_data_windows[i_curve_data_index] = A_receive_data[i_curve_data_index]
                    ...
                    # print("graph_data_setting() - A_graph_handle[C_GRAPH_DEFINE.ADC_DELTA_GRAPH].A_data_windows[",i_curve_data_index,"] : ", A_graph_handle[C_GRAPH_DEFINE.ADC_DELTA_GRAPH].A_data_windows[i_curve_data_index])
                    # print("graph_data_setting() - A_graph_handle[C_GRAPH_DEFINE.ADC_DELTA_GRAPH_ZOOM].A_data_windows[",i_curve_data_index,"] : ", A_graph_handle[C_GRAPH_DEFINE.ADC_DELTA_GRAPH_ZOOM].A_data_windows[i_curve_data_index])

            if not Q_bandfilter_graph_data_buffer.empty():
                # print("graph_data_setting() - Q_bandfilter_graph_data_buffer.qsize() : ", Q_bandfilter_graph_data_buffer.qsize())
                A_receive_data = Q_bandfilter_graph_data_buffer.get()
                # print("A_receive_data : ", A_receive_data)
                for i_curve_data_index in range(C_CURVE_DEFINE.GRAPH_START, C_CURVE_DEFINE.DATA_CURVE + 1, 1):
                    A_graph_handle[C_GRAPH_DEFINE.BANDFILTER_GRAPH].A_data_windows[i_curve_data_index] = A_receive_data[i_curve_data_index]
                    # print("graph_data_setting() - A_graph_handle[C_GRAPH_DEFINE.BANDFILTER_GRAPH].A_data_windows[",i_curve_data_index,"] : ", A_graph_handle[C_GRAPH_DEFINE.BANDFILTER_GRAPH].A_data_windows[i_curve_data_index])
...
def graph_init():
    global _screen_window_count, A_graph_handle
    ...
    for sel_graph_handle_num, sel_graph_handle in builtins.enumerate(list(A_graph_handle)):
        ...
        if sel_graph_handle.win is None:
            ...
            if sel_graph_handle_num == C_GRAPH_DEFINE.BANDFILTER_GRAPH:
                sel_graph_handle.plot.setYRange(-A_GRAPH_Y_RANGE_DEFINE[sel_graph_handle_num], A_GRAPH_Y_RANGE_DEFINE[sel_graph_handle_num], padding=0)
            else:
        ...
        sel_graph_handle.last_data_text.setPos(A_GRAPH_X_RANGE_DEFINE[sel_graph_handle_num] - 5, 0)         # x, y 위치 (조정 가능)
        ...
        if sel_graph_handle_num > C_GRAPH_DEFINE.ADC_GRAPH:
...
def graph_refresh():
    global A_graph_handle
    try:
        # print("list(A_graph_handle) : ", list(A_graph_handle))

        # 모든 그래프에 대해서
        for sel_graph_handle_num, sel_graph_handle in builtins.enumerate(list(A_graph_handle)):
            # print("graph_refresh() - sel_graph_handle_num : ", sel_graph_handle_num)
            # print("graph_refresh() - sel_graph_handle.A_data_windows : ", sel_graph_handle.A_data_windows)
            
            for sel_curve_num, sel_curve in builtins.enumerate(list(sel_graph_handle.curve)):
                if sel_curve_num < C_CURVE_DEFINE.TP1_CURVE:
                    # print("graph_refresh() - sel_curve_num : ", sel_curve_num)
                    # print(sel_graph_handle.A_data_windows[sel_curve_num])
                    sel_curve.setData(sel_graph_handle.A_data_windows[sel_curve_num])   # [][..., ..., ....]

            # if sel_graph_handle_num > C_GRAPH_DEFINE.ADC_GRAPH:
            #     print("sel_graph_handle.A_data_windows[C_CURVE_DEFINE.DATA_CURVE] : ", sel_graph_handle.A_data_windows[C_CURVE_DEFINE.DATA_CURVE])
            #     print("sel_graph_handle.A_data_windows[C_CURVE_DEFINE.OCCU_CURVE] : ", sel_graph_handle.A_data_windows[C_CURVE_DEFINE.OCCU_CURVE])
            ...
            #         +f"TP1(Red): {int(sel_graph_handle.A_data_windows[C_CURVE_DEFINE.TP1_CURVE])}\n"
            #         )
            ...
            if sel_graph_handle_num == C_GRAPH_DEFINE.ADC_GRAPH:
                ...
                i_last_min_data = min(sel_graph_handle.A_data_windows[C_CURVE_DEFINE.DATA_CURVE])
                ...
                i_last_mid_data = median(sel_graph_handle.A_data_windows[C_CURVE_DEFINE.DATA_CURVE])
                ...
                i_last_max_data = max(sel_graph_handle.A_data_windows[C_CURVE_DEFINE.DATA_CURVE])
            ...
            elif sel_graph_handle_num == C_GRAPH_DEFINE.ADC_DELTA_GRAPH or sel_graph_handle_num == C_GRAPH_DEFINE.ADC_DELTA_GRAPH_ZOOM:
                # print("sel_graph_handle.A_data_windows[C_CURVE_DEFINE.DATA_CURVE] : ", sel_graph_handle.A_data_windows[C_CURVE_DEFINE.DATA_CURVE])
                # print("sel_graph_handle.A_data_windows[C_CURVE_DEFINE.OCCU_CURVE] : ", sel_graph_handle.A_data_windows[C_CURVE_DEFINE.OCCU_CURVE])
                sel_graph_handle.last_data_text.setText(
                    f" ".join([str(x) for x in sel_graph_handle.A_data_windows[C_CURVE_DEFINE.DATA_CURVE]])+"\n"
                ...
                i_tp1 = int(sel_graph_handle.A_data_windows[C_CURVE_DEFINE.TP1_CURVE])
                ...
                i_last_min_data = min(sel_graph_handle.A_data_windows[C_CURVE_DEFINE.DATA_CURVE])
                sel_graph_handle.data_windows_min_line.setPos(i_last_min_data)
                sel_graph_handle.data_windows_min_text.setPos(A_GRAPH_X_RANGE_DEFINE[sel_graph_handle_num] - 1, i_last_min_data - 50)
                sel_graph_handle.data_windows_min_text.setText(f"MIN_{A_GRAPH_TITLE_DEFINE[sel_graph_handle_num]}: {i_last_min_data}")

                i_last_mid_data = median(sel_graph_handle.A_data_windows[C_CURVE_DEFINE.DATA_CURVE])
                sel_graph_handle.data_windows_mid_line.setPos(i_last_mid_data)
                sel_graph_handle.data_windows_mid_text.setPos(A_GRAPH_X_RANGE_DEFINE[sel_graph_handle_num] - 1, i_last_mid_data - 10)
                sel_graph_handle.data_windows_mid_text.setText(f"MID_{A_GRAPH_TITLE_DEFINE[sel_graph_handle_num]}: {i_last_mid_data}")
            ...
            elif sel_graph_handle_num == C_GRAPH_DEFINE.BANDFILTER_GRAPH:
                # print("sel_graph_handle.A_data_windows[C_CURVE_DEFINE.DATA_CURVE] : ", sel_graph_handle.A_data_windows[C_CURVE_DEFINE.DATA_CURVE])
                # print("sel_graph_handle.A_data_windows[C_CURVE_DEFINE.OCCU_CURVE] : ", sel_graph_handle.A_data_windows[C_CURVE_DEFINE.OCCU_CURVE])
                # sel_graph_handle.last_data_text.setText(
                #     f" ".join([str(x) for x in sel_graph_handle.A_data_windows[C_CURVE_DEFINE.DATA_CURVE]])+"\n"
                #     + f"RAW/Delta(White): {sel_graph_handle.A_data_windows[C_CURVE_DEFINE.DATA_CURVE][0]}\n"
                #     # +f"MIN MAX 중앙값(Blue): {((min(sel_graph_handle.A_data_windows[C_CURVE_DEFINE.DATA_CURVE]) + max(sel_graph_handle.A_data_windows[C_CURVE_DEFINE.DATA_CURVE])) / 2)}\n"
                #     # +f"중앙값(Yellow): {median(sel_graph_handle.A_data_windows[C_CURVE_DEFINE.DATA_CURVE])}\n"
                #     # +f"평균값(Orange): {mean(sel_graph_handle.A_data_windows[C_CURVE_DEFINE.DATA_CURVE])}\n"
                #     )
                sel_graph_handle.last_data_text.setText(
                    "\n".join(
                        " ".join(f"{x:.6f}" for x in sel_graph_handle.A_data_windows[C_CURVE_DEFINE.DATA_CURVE][i:i+5])
                        for i in range(0, len(sel_graph_handle.A_data_windows[C_CURVE_DEFINE.DATA_CURVE]), 5)
                    )
                    + "\n"
                    + f"RAW/Delta(White): {sel_graph_handle.A_data_windows[C_CURVE_DEFINE.DATA_CURVE][0]}\n"
                    # + f"MIN MAX 중앙값(Blue): {((min(sel_graph_handle.A_data_windows[C_CURVE_DEFINE.DATA_CURVE]) + max(sel_graph_handle.A_data_windows[C_CURVE_DEFINE.DATA_CURVE])) / 2)}\n"
                ...
                i_last_min_data = min(sel_graph_handle.A_data_windows[C_CURVE_DEFINE.DATA_CURVE])
                sel_graph_handle.data_windows_min_line.setPos(i_last_min_data)
                sel_graph_handle.data_windows_min_text.setPos(A_GRAPH_X_RANGE_DEFINE[sel_graph_handle_num] - 1, i_last_min_data - 20)
                sel_graph_handle.data_windows_min_text.setText(f"MIN_{A_GRAPH_TITLE_DEFINE[sel_graph_handle_num]}: {i_last_min_data}")

                i_last_mid_data = median(sel_graph_handle.A_data_windows[C_CURVE_DEFINE.DATA_CURVE])
                sel_graph_handle.data_windows_mid_line.setPos(i_last_mid_data)
                sel_graph_handle.data_windows_mid_text.setPos(A_GRAPH_X_RANGE_DEFINE[sel_graph_handle_num] - 1, i_last_mid_data - 5)
                sel_graph_handle.data_windows_mid_text.setText(f"MID_{A_GRAPH_TITLE_DEFINE[sel_graph_handle_num]}: {i_last_mid_data}")
                ...
                sel_graph_handle.last_data_text.setPos(A_GRAPH_X_RANGE_DEFINE[sel_graph_handle_num] - 5, A_GRAPH_Y_RANGE_DEFINE[sel_graph_handle_num] * 0.3)
