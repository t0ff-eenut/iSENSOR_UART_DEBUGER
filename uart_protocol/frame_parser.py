...
import uart_protocol.data_models
...
class FrameParser:
    ...
    def __init__(self):
        ...
        self.stats  = uart_protocol.data_models.ParserState()
...
#         self.current_checksum = None
    ...
    def feed_byte(self, input_i_byte) -> Optional[UartFrame]: # UartFrame 객체 또는 None을 반환
        """바이트를 파서에 공급"""
        self.buffer.append(input_i_byte)
